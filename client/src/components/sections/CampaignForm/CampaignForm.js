            ...
            <div id="CampaignForm">
                ...
                <Row>
                    ...
                    <MDBCard style={{ background: "#1c1c1c" }}>
                        ...
                        <Row>
                        <Col lg={3}>
                            <MDBView hover className="CreateCampaign-Image">
                            <MDBAvatar
                        ...
                        <Col>
                            <Row style={{ marginBottom: "2%" }}>
                                ...
                                <div className="input-group-prepend">
                                    <span className="input-group-text CreateCampaign_InputIcon" style={{ paddingRight: "15px" }} id="basic-addon">
                                    <i className="fa fa-globe-americas prefix" />
                                    </span>
                                </div>
                                <input 
                                type="text" 
                                className="form-control CreateCampaign_Input" 
                            ...
                            <Row style={{ marginBottom: "2%" }}>
                                ...
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text CreateCampaign_InputIcon" id="basic-addon">
                            ...
                            <Row>
                                <Col>
                                <div className="input-group CreateCampaign_Select">
                                <div className="input-group-prepend">
                                    <span className="input-group-text CreateCampaign_InputIcon" style={{ paddingRight: "18px" }} id="basic-addon">
                                ...
                                labelClass="CreateCampaign_Select"
                                className="form-control CreateCampaign_Select"
